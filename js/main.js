...
//  1- usul
// for (var i = 0; i < mevalar.length; i++) {
...
//  3- usul
// for (var item of mevalar) {
//     console.log(item);
// }

// var narxlar= [8000, 9000, 11000, 18000]
// var narxlar = {
//     l0: 8000,
//     l1: 9000,
//     l2: 11000,
...
var elList = document.querySelector(".row");
    ...
    for (let i = 0; i < 20; i++) {
        ...
        new_list.setAttribute("class", "col p-5 rounded-3")
        var new_h2 = document.createElement("h4");
        new_h2.setAttribute("class", "pt-2 text-center")
        var new_img = document.createElement("img");
        var news_p = document.createElement("p")
        news_p.setAttribute("class", "fs-6 text-center")
        console.log(new_img);
        ...
        new_h2.textContent = pokemons[i].name;
        new_list.appendChild(new_h2);

        news_p.textContent = "type:  "  + pokemons[i].type ;
        new_list.appendChild(news_p);
